...
@section('title', 'PR Procurement Approval')
                                ...
                                @foreach($vessels as $code => $name)
                                    <li class="nav-item">
                                        <a class="nav-link {{ $selectedVessel == $code ? 'active' : '' }}"
                                           href="{{ route('pro.pr.index',['vessel'=>$code]) }}">
                                            {{ $name }}
                                        </a>
                                    </li>
                                @endforeach
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="actionDropdown">
                                                        <li>
                                                            <a href="{{ route('pro.pr.show', $pr) }}" class="dropdown-item" type="button">View</a>
                                                        </li>
                                                        <li>
                                                            <a href="{{ route('pro.pr.edit', $pr) }}" class="dropdown-item" type="button">Update</a>
                                                        </li>
                                                        <li>
