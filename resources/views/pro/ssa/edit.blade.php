...
@section('title', 'Procurement Approve SSA')
                ...
                <div class="col-12">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-header pb-0 bg-light">
                            <h4 class="mb-0 text-center">Procurement Approval SSA</h4>
                        </div>

                        <div class="card-body px-4 pt-4 pb-4">

                            <form action="{{ route('pro.ssa.update', $ssa) }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="mb-4 p-3 border rounded bg-white">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="pro_remark" class="form-control"
                                                value="{{ old('pro_remark', $ssa->pro_remark ?? '') }}"
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div class="form-check form-switch">
                                            <input type="checkbox" class="form-check-input" id="approvedSwitch"
                                                {{ old('pro_status', $ssa->pro_status) === 'APPROVED' ? 'checked' : '' }}>

                                            <span id="approvedBadge"
                                                class="badge {{ $ssa->pro_status === 'APPROVED' ? 'bg-success' : 'bg-warning' }}">
                                                {{ old('pro_status', $ssa->pro_status) ?? 'PENDING' }}
                                            </span>
                                        </div>
                                    </div>

                                    {{-- Hidden input for submit --}}
                                    <input type="hidden" name="pro_status" id="approvedStatus"
                                        value="{{ old('pro_status', $ssa->pro_status) ?? 'PENDING' }}">
                                </div>
