                ...
                <div class="col-12">
                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body px-4 pt-4 pb-4">
                            <form action="{{ route('ssr.request.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf

                                {{-- Section 1: SSR Details --}}
                                <div class="mb-4 p-3 border rounded bg-light">
                                    <h6 class="mb-3 text-uppercase fw-bold text-primary">SSR Details</h6>
                                    <div class="row mb-3">
                                        <div class="col-md-6 mb-3">
                                            <label for="ssr_no" class="form-label">SSR No.</label>
                                            <input type="text" name="ssr_no" id="ssr_no" class="form-control" placeholder="Enter SSR No." required>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="ssr_date" class="form-label">SSR Date</label>
                                            <input type="date" name="ssr_date" id="ssr_date" class="form-control" required>
                                        </div>
                                    </div>
